  ...
  <div class="clue">
        ...
        <el-row :gutter="20">
          ...
          <el-col :span="6">
            <el-form-item label="渠道来源">
              <el-select v-model="query.channelId" size="small" placeholder="请选择">
                <el-option v-for="item in options" :key="item.value" :label="item.channelName" :value="item.channelId">
                </el-option>
              </el-select>
            </el-form-item>
          </el-col>
        ...
        <el-row :gutter="20">
          <el-col :span="6">
            <el-form-item label="线索状态">
              <el-select v-model="query.status" size="small" placeholder="请选择">
                <el-option v-for="item in statusList" :key="item.value" :label="item.dictLabel" :value="item.dictValue">
                </el-option>
              </el-select>
            </el-form-item>
          </el-col>
          <el-col :span="7">
            <el-form-item label="跟进时间">
              <el-date-picker size="small" v-model="query.dateRange" type="datetimerange" start-placeholder="开始日期"
                end-placeholder="结束日期" :default-time="['12:00:00']" format="yyyy-MM-dd hh:mm:ss"
    ...
    <div class="tableDiv">
      <div class="btn" style="text-align: left">
        <el-button type="primary" size="small" plain icon="el-icon-search" @click="addShow">新增</el-button>
        <el-button type="danger" size="small" plain icon="el-icon-search" :disabled="delId.length === 0"
          @click="delClue">删除</el-button>
        <el-button type="success" size="small" plain icon="el-icon-search" :disabled="!(delId.length == 1)"
      ...
      <pagination :total="total" :page="query.pageNum" @size="setSize" @current="setCurrent"></pagination>
    </div>
          ...
          <el-row>
            <el-col :span="12">
              <el-form-item label="手机号码" prop="phone">
                <el-input size="small" maxlength="11" show-word-limit v-model="ruleForm.phone"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12">
          ...
          <el-row>
            <el-col :span="12">
              <el-form-item label="渠道来源" prop="channelId">
                <el-select v-model="ruleForm.channelId" placeholder="请选择活动区域" style="width: 100%" size="small"
            ...
            <el-col :span="12">
              <el-form-item label="活动信息" prop="activityId">
                <el-select v-model="ruleForm.activityId" placeholder="请选择活动区域" style="width: 100%" size="small">
            ...
            <el-col :span="12">
              <el-form-item label="客户性别" prop="gender">
                <el-radio-group v-model="ruleForm.gender">
                  <el-radio :label="item.value" v-for="(item, index) in sex" :key="index">{{ item.label }}</el-radio>
                </el-radio-group>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="客户年龄" prop="age">
                <el-input-number v-model="ruleForm.age" :min="10" :max="80" label="描述文字" size="small"></el-input-number>
              </el-form-item>
            </el-col>
          </el-row>
          <el-row>
...
<script>
import { list, channels, clueStatus, activity, clueAdd, deleteClue, summaryClue, updateClue } from "@/api/clue"
...
export default {
  ...
  methods: {
    ...
    // 删除
    delClue() {
      this.$confirm(`此操作将永久删除编号为${this.delId}, 是否继续?`, '提示', {
